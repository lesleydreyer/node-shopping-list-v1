...
const router = express.Router();//look into what this means
...
Recipes.create('tacos', ['ground beef', 'taco shells', 'seasoning', 'cheese', 'tomatoes']);
Recipes.create('roasted green beans', ['green beans', 'olive oil', 'garlic']);
